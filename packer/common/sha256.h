...
static void sha256_transform(sha256_ctx* ctx, const uint8_t* data) {
    /* K[] 必须放进 .lock.rdata 节，否则会被 stub.ld 的 /DISCARD/ 丢掉
     * 导致 PIC stub 运行时访问到错误地址，hash 计算错误 */
#ifdef WINLOCK_PIC
    static const uint32_t K[64] __attribute__((section(".lock.rdata"), used, aligned(16))) = {
#else
    static const uint32_t K[64] = {
        ...
        0x19a4c116,0x1e376c08,0x2748774c,0x34b0bcb5,0x391c0cb3,0x4ed8aa4a,0x5b9cca5f,0x682e6ff3,
